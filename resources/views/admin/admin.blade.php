                                        ...
                                        <div class="bg-gradient px-4 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="mr-1">
                                                    ...
                                                    Hello   {{Session::get('user')->first()->name}}
                                                       </h4>
                                                ...
                                                <a href="{{url('/admin/create')}}" class="text-white font-20 tooltip-wrapper" data-toggle="tooltip" data-placement="top" title="" data-original-title="Logout"> <i
                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                <a class="has-arrow" href="javascript:void(0)" aria-expanded="false">
                                    ...
                                    <span class="nav-title">occasion</span>
                                    <span class="nav-label label label-danger">9</span>
                                </a>
                                <ul aria-expanded="false">
                                    <li class="active"> <a  href="{{ route('occasion.index') }}">Show </a> </li>
                                    <li> <a href="{{ route('occasion.create') }}">Add</a> </li>
                            ...
                            <!-- <li><a href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">occasion</span></a> </li> -->
                            <!-- <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-calendar"></i><span class="nav-title">occasion</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href='{{ route('occasion.create') }}'>Add</a> </li>
                                    <li> <a href='{{ route('occasion.index') }}'>Show</a> </li>
                                </ul>
                            </li>
                           -->
                            <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-calendar"></i><span class="nav-title">FAQ</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href='{{ route('faq.create') }}'>Add</a> </li>
                                    <li> <a href='{{ route('faq.index') }}'>Show</a> </li>
                                </ul>
                            </li>
                            ...
                            <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-calendar"></i><span class="nav-title">Product</span></a>
                                <ul aria-expanded="false">
                                    ...
                                    <li> <a href='{{ route('product.index') }}'>Show</a> </li>
                                </ul>
                            </li>
                            <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-calendar"></i><span class="nav-title">Admin</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href="{{ url('/signup') }}">New Admin Create</a> </li>
                            ...
                            <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-calendar"></i><span class="nav-title">Orders</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href="{{  url('/showorders') }}">Show Orders</a> </li>
